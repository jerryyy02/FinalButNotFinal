    ...
    <div class="col-md-6 col-md-offset-3">
      <div class="panel panel-login">
        <div class="panel-body">
          <div class="row">
            <div class="col-lg-12">
            <h2>Batch Allocation <a href="logout.html" class="form-control btn logout">Logout </a> </h2>
             <form id="login-form" action="batchAllocation.html" method="post" role="form" style="display: block;">
                  ...
                  <div class="form-group">
                    <input type="text" name="startDate" id="startDate" tabindex="2" class="form-control" placeholder="Start Date" value="">
                  </div>
                  <div class="form-group">
                    <input type="text" name="endDate" id="endDate" tabindex="3" class="form-control" placeholder="End Date" value="">
                  </div>
                  <div class="form-group">
                    <input type="text"  name="closeDate" id="closeDate" tabindex="3" class="form-control"  placeholder="Close Date">
                  </div>
                  <div class="form-group">
                    <div class="row">
                      <div class="col-sm-6 col-sm-offset-3">
                        <input type="submit" name="register-submit" id="register-submit" tabindex="4" class="form-control btn btn-register" value="Allocate">
                      </div>
                    </div>
                  </div>
              </form>
