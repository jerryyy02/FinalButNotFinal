        ...
        <div class="panel-body">
          <div class="row">
            ...
            <h2>Skill Form <a href="logout.html" class="form-control btn logout">Logout </a> </h2>
             <form id="login-form" action="insertSkill1.html" method="post" role="form" style="display: block;">
               
                  <div class="form-group">
                    <input type="text" name="facultyId" id="facultyId" tabindex="1" class="form-control" placeholder="Enter FacultyId" value="">
                  </div>
                  <div class="form-group">
                    <input type="text" name="skill" id="skill" tabindex="1" class="form-control" placeholder="Enter Skill" value="">
                  </div>
                  <div class="form-group">
                    <input type="text"  name="certification" id="certification" tabindex="2" class="form-control" placeholder="Enter Certification">
                  </div>
                  <div class="form-group">
                    <div class="row">
