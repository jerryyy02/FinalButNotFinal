      ...
      <div class="panel panel-login">
        <div class="panel-body">
          ...
          <div class="row">
            ...
            <div class="col-lg-12">
           <h2>Update Faculty <a href="logout.html" class="form-control btn logout">Logout </a> </h2> 
             <form id="login-form" action="addFaculty.html" method="post" role="form" style="display: block;">
             
                  <div class="form-group">
                    <input type="text" name="fisrtName" id="fisrtName" tabindex="1" class="form-control" placeholder="Enter First Name" value="">
                  </div>
                   <div class="form-group">
                    <input type="text" name="lastName" id="lastName" tabindex="1" class="form-control" placeholder="Enter Last Name" value="">
                  </div>
                  <div class="form-group">
                    <input type="text" name="age" id="age" tabindex="1" class="form-control" placeholder="Enter Age" value="">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <input type="text" name="contactNo" id="contactNo" tabindex="1" class="form-control" placeholder="Enter Contact No" value="">
                  </div>
				<div class="form-group">
                    <input type="email" name="emailId" id="emailId" tabindex="1" class="form-control" placeholder="Enter Email Id" value="">
                  </div>
                  <div class="form-group">
                    <input type="password" name="password" id="password" tabindex="1" class="form-control" placeholder="Enter Password" value="">
                  </div>
                  <div class="form-group">
                    <input type="text" name="facultyId" id="facultyId" tabindex="1" class="form-control" placeholder="Enter Associate Id" value="">
                  </div>
                  <div class="form-group">
                    <div class="row">
