    ...
    <div class="col-md-6 col-md-offset-3">
      <div class="panel panel-login">
        <div class="panel-body">
          <div class="row">
            <div class="col-lg-12">
            <h2>Batch Form<a href="logout.html" class="form-control btn logout">Logout </a> </h2> 
             <form id="login-form" action="insertBatch.html" method="post" role="form" style="display: block;">
                
                  <div class="form-group">
                    <input type="text" name="batchId" id="moduleId" tabindex="1" class="form-control" placeholder="Enter BatchId" value="">
                  </div>
                  <div class="form-group">
                    <input type="text" name="batchName" id="moduleName" tabindex="1" class="form-control" placeholder="Enter BatchName" value="">
                  </div>
                  <div class="form-group">
                    <input type="text"  name="batchDetails" id="moduleDesc" tabindex="2" class="form-control"  placeholder="Enter BatchDetails">
                  </div>
                  <div class="form-group">
                    <div class="row">
