    ...
    <div class="col-md-6 col-md-offset-3">
      <div class="panel panel-login">
        <div class="panel-body">
          <div class="row">
            <div class="col-lg-12">
            <h2>Report Management<a href="logout.html" class="form-control btn logout">Logout </a> </h2>
             <form id="login-form" action="reportManagement.html" method="post" role="form" style="display: block;">
                  ...
                  <div class="form-group">
                    <input type="text" name="weeklyReport" id="weeklyReport" tabindex="2" class="form-control" placeholder="Weekly Report" value="">
                  </div>
                   <div class="form-group">
                  ...
                  <div class="form-group">
                    <input type="text" name="mockTest" id="mockTest" tabindex="3" class="form-control" placeholder="Mock Test" value="">
                  </div>
                  <div class="form-group">
