    ...
    <div class="col-md-6 col-md-offset-3">
      <div class="panel panel-login">
        <div class="panel-body">
          <div class="row">
            <div class="col-lg-12">
            <h2>Generate Report <a href="logout.html" class="form-control btn logout">Logout </a> </h2>
             <form id="login-form" action="generateReport.html" method="post" role="form" style="display: block;">
                  ...
                  <div class="form-group">
                    <div class="row">
                      <div class="col-sm-6 col-sm-offset-3">
                        <input type="submit" name="register-submit" id="register-submit" tabindex="4" class="form-control btn btn-register" value="Generate"><br><br>
                      	<input type="reset" name="register-submit" id="register-submit" tabindex="4" class="form-control btn btn-register" value="Reset">
           			 </div>
                    </div>
                  </div>
              </form>
