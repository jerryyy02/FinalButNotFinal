    ...
    <div class="col-md-6 col-md-offset-3">
      <div class="panel panel-login">
        <div class="panel-body">
          <div class="row">
            <div class="col-lg-12">
            <h2>Module Registration<a href="logout.html" class="form-control btn logout">Logout </a> </h2>
             <form id="login-form" action="addModule.html" method="post" role="form" style="display: block;">
                
                  <div class="form-group">
                    <input type="text" name="moduleId" id="moduleId" tabindex="1" class="form-control" placeholder="Module Id" value="">
                  </div>
                  <div class="form-group">
                    <input type="text" name="moduleName" id="moduleName" tabindex="1" class="form-control" placeholder="Module Name" value="">
                  </div>
                  <div class="form-group">
                    <input type="text" name="moduleDesc" id="moduleDesc" tabindex="2" class="form-control" placeholder="Module Description">
                  </div>
                  <div class="form-group">
                    <div class="row">
