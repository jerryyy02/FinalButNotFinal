      ...
      <div class="panel panel-login">
        <div class="panel-body">
          ...
          <div class="row">
            ...
            <div class="col-lg-12">
           <h2>REGISTER <a href="logout.html" class="form-control btn logout">Logout </a> </h2> 
             <form id="login-form" action="registerUser.html" method="post" role="form" style="display: block;">
                  ...
                  <div class="form-group">
                    <input type="password" name="password" id="email" tabindex="1" class="form-control" placeholder="Password" value="">
                  </div>
